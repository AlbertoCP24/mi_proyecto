...
## Objetivo
El objetivo de este proyecto de investigación propone en analizar un conjunto de aplicaciones de malware de androide que se encuentran etiquetados y categorizados en la familia correspondiente. 
Para realizar este estudio se dispone de datasets que permitan comprender los cambios de comportamiento de estas categorías y familias de malware, se extraen seis categorías de características después de ejecutar el malware en un entorno emulado. Las principales características extraídas incluyen:
...
Prueba realizada por Jose Luis
